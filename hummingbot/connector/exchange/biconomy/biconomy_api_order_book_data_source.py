    ...
    async def _subscribe_channels(self, ws: WSAssistant):
        ...
        try:
            ...
            for trading_pair in self._trading_pairs:
                ...
                quote_precision = str(self._connector.trading_rules[trading_pair].min_price_increment)
                
                depth_params = [symbol,100, quote_precision ]
    ...
    async def _parse_order_book_diff_message(self, raw_message: Dict[str, Any], message_queue: asyncio.Queue):
        if "result" not in raw_message:
            ...
            order_book_message: OrderBookMessage = BiconomyOrderBook.diff_message_from_exchange(
                raw_message["params"][1], time.time(), {"trading_pair": trading_pair})
